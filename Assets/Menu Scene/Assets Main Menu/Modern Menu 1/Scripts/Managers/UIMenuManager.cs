...
using UnityEngine.SceneManagement;
	...
	namespace SlimUI.ModernMenu{
		public class UIMenuManager : MonoBehaviour {
			...
			private bool TryResolveCameraAnimator()
			{
				...
				if (CameraObject == null)
				{
					Debug.LogWarning("UIMenuManager could not find an Animator on " + gameObject.name + ". Menu camera transitions will be skipped.");
					return false;
				}
